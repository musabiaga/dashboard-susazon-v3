...
> 🔧 **V4.4 en curso (2026-09-06):** sync automática diaria (Vercel Cron) + editor de metas robusto — ver `LO_NUEVO.md` (bloque V4.4) y D045 en `SESSION_LOG.md`. Pendiente Mauricio: `CRON_SECRET` en Vercel.
>
